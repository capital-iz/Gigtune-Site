...
<main class="flex-1">
  <div class="w-full px-4 sm:px-6 lg:px-10 xl:px-14 2xl:px-16 py-12">
    <div class="mb-10 ">
      <h1 class="text-3xl md:text-4xl font-bold text-white mb-3">Book an Artist</h1>
      <p class="text-slate-400 text-base md:text-lg max-w-2xl ">Start a booking request with secure workflow.</p>
    </div>
    <div class="mt-8">
      <?php
